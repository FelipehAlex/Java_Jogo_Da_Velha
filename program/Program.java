    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (jogador == 1) {
                ...
                if (ChecarTabela.verificaTabela(tabela, jogador_numero_1)) {
                    tabela[jogador_numero_1] = j1;
                    jogador = 2;
                    System.out.print(ChecarTabela.desenhoTabela(tabela));
                } else {
                    System.out.println(ChecarTabela.desenhoTabela(tabela));
                    System.out.println("Posição ja ocupada");
                }
            }

            if (ChecarTabela.verificaVitoria(tabela, j1)) {
                System.out.print("Jogador numero 1 ganhou");
                break;
            }
            if (ChecarTabela.verificaEmpate(tabela)) {
            ...
            if (jogador == 2) {
                ...
                if(ChecarTabela.verificaTabela(tabela, jogador_numero_2)){
            ...
            if (ChecarTabela.verificaVitoria(tabela, j2)){
